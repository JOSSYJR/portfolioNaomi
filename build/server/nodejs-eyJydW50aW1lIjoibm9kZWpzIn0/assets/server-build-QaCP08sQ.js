...
const sprites = "/assets/icons-B8KLzGn0.svg";
const Icon = forwardRef(({ icon: icon2, className, size, ...rest }, ref) => {
  return /* @__PURE__ */ jsx(
    "svg",
    {
      "aria-hidden": true,
      ref,
      className: classes(styles$x.icon, className),
      width: size || 24,
      height: size || 24,
      ...rest,
...
const Text = ({
  ...
  return /* @__PURE__ */ jsx(
    Component,
    {
      className: classes(styles$w.text, className),
      "data-align": align,
      "data-size": size,
      "data-weight": weight,
...
const Loader = forwardRef(
  ({ className, style, width = 32, height = 4, text: text2 = "Loading...", center, ...rest }, ref) => {
    ...
    if (reduceMotion) {
      return /* @__PURE__ */ jsx(Text, { className: classes(styles$v.text, className), weight: "medium", ...rest, children: text2 });
    }
    return /* @__PURE__ */ jsx(
      "div",
      {
        ref,
        className: classes(styles$v.loader, className),
        "data-center": center,
        style: cssProps({ width, height }, style),
        ...rest,
        children: /* @__PURE__ */ jsx("div", { className: styles$v.span })
      }
    );
  }
);
...
const ButtonContent = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Component,
      {
        className: classes(styles$u.button, className),
        ...
        children: [
          ...
          !!children && /* @__PURE__ */ jsx("span", { className: styles$u.text, children }),
...
const VisuallyHidden = forwardRef(
  ({ className, showOnFocus, as: Component = "span", children, visible, ...rest }, ref) => {
    return /* @__PURE__ */ jsx(
      Component,
      {
        className: classes(styles$t.hidden, className),
...
const DecoderText = memo(
  ({ text: text2, start = true, delay: startDelay = 0, className, ...rest }) => {
    ...
    useEffect(() => {
      ...
      const renderOutput = () => {
        const characterMap = output.current.map((item2) => {
          return `<span class="${styles$s[item2.type]}">${item2.value}</span>`;
        });
    ...
    return /* @__PURE__ */ jsxs("span", { className: classes(styles$s.text, className), ...rest, children: [
      /* @__PURE__ */ jsx(VisuallyHidden, { className: styles$s.label, children: text2 }),
      /* @__PURE__ */ jsx("span", { "aria-hidden": true, className: styles$s.content, ref: container2 })
    ] });
  }
);
...
const Heading = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(
    Component,
    {
      className: classes(styles$r.heading, className),
      "data-align": align,
      "data-weight": weight,
...
const Image$1 = ({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      className: classes(styles$p.image, className),
...
const ImageElements = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: styles$p.elementWrapper,
      "data-reveal": reveal,
      "data-visible": inViewport || loaded,
      ...
      children: [
        isVideo && hasMounted && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          !noPauseButton && /* @__PURE__ */ jsxs(Button, { className: styles$p.button, onClick: togglePlaying, children: [
        ...
        showPlaceholder && /* @__PURE__ */ jsx(
          ...
          {
            "aria-hidden": true,
            className: styles$p.placeholder,
            "data-loaded": loaded,
            "data-cover": cover,
...
function Error$1({ error: error2 }) {
  ...
  return /* @__PURE__ */ jsxs("section", { className: styles$q.page, children: [
    ...
    /* @__PURE__ */ jsx(Transition, { in: true, children: ({ visible }) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
      /* @__PURE__ */ jsx("div", { className: styles$q.details, children: /* @__PURE__ */ jsxs("div", { className: styles$q.text, children: [
        !flatlined && /* @__PURE__ */ jsx(
          Heading,
          {
        ...
        flatlined && /* @__PURE__ */ jsxs(
          Heading,
          {
            className: styles$q.titleFlatline,
            "data-visible": visible,
            level: 2,
            as: "h1",
            children: [
        ...
        /* @__PURE__ */ jsx(Text, { className: styles$q.description, "data-visible": visible, as: "p", children: message }),
        flatlined ? /* @__PURE__ */ jsx(
          Button,
          {
            secondary: true,
      ...
      /* @__PURE__ */ jsxs("div", { className: styles$q.videoContainer, "data-visible": visible, children: [
        /* @__PURE__ */ jsx(
          Image$1,
          {
            reveal: true,
...
const twitter$1 = "@Robeleph221";
const github = "robeleph22";
const linkedin = "robel-ephrem-1a4574272";
const ascii = "ሮቤል Portfolio";
const config = {
  name: name$2,
  role,
  disciplines,
...
const links$1 = () => [
  ...
  { rel: "icon", href: "/R-logo.ico" },
  { rel: "icon", href: "/r-icon.svg", type: "image/svg+xml" },
  { rel: "shortcut_icon", href: "/public/logo.png", type: "image/png", sizes: "64x64" },
  { rel: "apple-touch-icon", href: "/public/logo.png", sizes: "256x256" },
...
const Footer = ({ className }) => /* @__PURE__ */ jsx("footer", { className: classes(styles$h.footer, className), children: /* @__PURE__ */ jsxs(Text, { size: "s", align: "center", children: [
  /* @__PURE__ */ jsx("span", { className: styles$h.date, children: `© ${(/* @__PURE__ */ new Date()).getFullYear()} ${config.name}.` }),
  /* @__PURE__ */ jsx(Link, { secondary: true, className: styles$h.link, href: "/humans.txt", target: "_self", children: "Crafted by yours truly" })
] }) });
  ...
  return /* @__PURE__ */ jsx(Transition, { in: true, timeout: msToNum(tokens.base.durationM), children: ({ visible, nodeRef }) => /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: styles$f.backgroundScrim, style: cssProps({ opacity }) })
      ]
    }
  ) });
};
const ProjectImage = ({ className, alt, ...rest }) => /* @__PURE__ */ jsx("div", { className: classes(styles$f.image, className), children: /* @__PURE__ */ jsx(Image$1, { reveal: true, alt, delay: 300, ...rest }) });
...
const ProjectSectionColumns = ({ className, centered, ...rest }) => /* @__PURE__ */ jsx(
  ...
  {
    className: classes(styles$f.sectionColumns, className),
...
const VolkiharLogo = "/assets/R-logo-Bvit3Ozm.png";
...
const Carousel = lazy(
  () => import("./index-F9kbclAp.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-C3ZUMqOU.js").then((module) => ({ default: module.Armor })));
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { children: [
        /* @__PURE__ */ jsx("div", { className: styles$e.armor, children: /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(Armor, { alt: "3D model of the Volkihar Knight armor" }) }) }),
        /* @__PURE__ */ jsxs("div", { className: styles$e.textSection, children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionContent, { children: [
        /* @__PURE__ */ jsx("div", { className: styles$e.logoContainer, children: /* @__PURE__ */ jsx(
          VolkiharLogo,
          {
            role: "img",
...
const Earth = lazy(() => import("./earth-Cnx7X0Fd.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-Cnx7X0Fd.js").then((module) => ({ default: module.EarthSection }))
);
...
const Divider = ({
  ...
  "div",
  {
    className: classes(styles$a.divider, className),
    style: cssProps(
      {
        lineWidth,
        lineHeight,
    ...
    ...rest,
    children: [
      /* @__PURE__ */ jsx("div", { className: styles$a.line, "data-collapsed": collapsed }),
      /* @__PURE__ */ jsx(
        "div",
        {
          className: styles$a.notch,
...
const gamestackTexture2Placeholder = "/assets/Eat-Addis-Food-Delivery-Addis-list-j1ifr8a5.jpg";
const gamestackTexturePlaceholder = "/assets/Eat-Addis-Food-Delivery-Addis-welcome-page-DbZRuME5.jpg";
const sliceTexturePlaceholder = "/assets/Semah-MCH-Center-CkDhqZQx.png";
const sprTexturePlaceholder = "/assets/ahunShoping-DL8-2GJA.png";
function subscribe() {
  return () => {
  };
}
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-DpBrfxMV.js").then((module) => ({ default: module.DisplacementSphere }))
);
    ...
    Section,
    {
      ...
      children: /* @__PURE__ */ jsx(Transition, { in: true, timeout: 3e3, children: ({ visible, status }) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
        ...
        /* @__PURE__ */ jsxs("header", { className: styles$6.text, children: [
          /* @__PURE__ */ jsx("h1", { className: styles$6.name, "data-visible": visible, id: titleId, children: /* @__PURE__ */ jsx(DecoderText, { text: config.name, delay: 800 }) }),
...
const profileImgLarge = "/assets/Robel-Profile-CYS9jK0R.jpg";
const katakana = "/assets/katakana-CiC-nKH5.svg";
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  /* @__PURE__ */ jsx(Text, { className: styles$5.description, "data-visible": visible, size: "l", as: "p", children: "I'm Robel Ephrem, a passionate software developer with 3 years of experience. Specializing in Flutter, React, Node.js, .Net , Firebase, TypeScript, MySQL and others. I thrive on crafting efficient solutions to real-world problems. I'm committed to staying updated with the latest trends and constantly improving my craft through learning and experimentation. I excel in diverse teams, fostering open communication and embracing different perspectives to achieve extraordinary results." })
] });
    ...
    Section,
    {
      ...
      children: /* @__PURE__ */ jsx(Transition, { in: visible || focused, timeout: 0, children: ({ visible: visible2, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$5.content, ref: nodeRef, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$5.column, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: styles$5.image, children: [
            /* @__PURE__ */ jsx(
              Image$1,
              {
                reveal: true,
            ...
            /* @__PURE__ */ jsx("svg", { className: styles$5.svg, "data-visible": visible2, viewBox: "0 0 136 766", children: /* @__PURE__ */ jsx("use", { href: `${katakana}#katakana-profile` }) })
          ] })
        ] })
      ] }) })
    }
...
const Model = lazy(
  () => import("./index-Cbznkw7X.js").then((module) => ({ default: module.Model }))
);
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${gamestackTexturePlaceholder} 375w, ${gamestackTexturePlaceholder} 750w`,
...
const serverManifest = { "entry": { "module": "/assets/entry.client-Du-QQlIP.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-Cxj6weuE.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/index-C1nQuyem.js", "/assets/visually-hidden-DEe2ugKV.js", "/assets/use-spring-DfxOLirH.js", "/assets/decoder-text-EXfoW_qo.js", "/assets/image-BEhxrdLd.js", "/assets/error-RQ3IpIZa.js", "/assets/useScrollToHash-C4ZhDZj9.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/config-CmmmZji6.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/image-cNt8ozvO.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/error-Cq_yTnRj.css", "/assets/root-D0VCIBbv.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "root", "path": "articles/modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-BDwI2CY3.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-BsIVDBKG.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BFcNhgSt.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/config-CmmmZji6.js", "/assets/image-BEhxrdLd.js", "/assets/meta-BSWQDWg9.js", "/assets/project-DIkBzT_i.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-Dgt82hGY.css"] }, "routes/projects.smart-sparrow": { "id": "routes/projects.smart-sparrow", "parentId": "root", "path": "projects/smart-sparrow", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CKxMEwwB.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/config-CmmmZji6.js", "/assets/image-BEhxrdLd.js", "/assets/meta-BSWQDWg9.js", "/assets/visually-hidden-DEe2ugKV.js", "/assets/project-DIkBzT_i.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/image-cNt8ozvO.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/project-CMTDR1YT.css", "/assets/route-INjNiGZW.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "root", "path": "articles/hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-DO4FFmeR.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-BsIVDBKG.js"], "css": [] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-lZNeOPaI.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/config-CmmmZji6.js", "/assets/image-BEhxrdLd.js", "/assets/meta-BSWQDWg9.js", "/assets/project-DIkBzT_i.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-Cvnrim9f.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BifblG3O.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/index-C1nQuyem.js", "/assets/visually-hidden-DEe2ugKV.js", "/assets/use-spring-DfxOLirH.js", "/assets/config-CmmmZji6.js", "/assets/decoder-text-EXfoW_qo.js", "/assets/divider-BWx6OcfP.js", "/assets/meta-BSWQDWg9.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/divider-BGrE333F.css", "/assets/meta-CErneW72.css", "/assets/route-CKif1uL8.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-B1UqgGiO.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/config-CmmmZji6.js", "/assets/index-C1nQuyem.js", "/assets/visually-hidden-DEe2ugKV.js", "/assets/use-spring-DfxOLirH.js", "/assets/meta-BSWQDWg9.js", "/assets/decoder-text-EXfoW_qo.js", "/assets/image-BEhxrdLd.js", "/assets/useScrollToHash-C4ZhDZj9.js", "/assets/divider-BWx6OcfP.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/route-P56FuPXN.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/image-cNt8ozvO.css", "/assets/divider-BGrE333F.css", "/assets/route-D3R5eEKe.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-m2UulJKW.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/config-CmmmZji6.js", "/assets/image-BEhxrdLd.js", "/assets/meta-BSWQDWg9.js", "/assets/project-DIkBzT_i.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-f8IImIqG.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-C7J-xIjV.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/index-C1nQuyem.js", "/assets/visually-hidden-DEe2ugKV.js", "/assets/use-spring-DfxOLirH.js", "/assets/decoder-text-EXfoW_qo.js", "/assets/image-BEhxrdLd.js", "/assets/error-RQ3IpIZa.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/image-cNt8ozvO.css", "/assets/error-Cq_yTnRj.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-B1UqgGiO.js", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-Baj1kt73.js", "/assets/heading-0TtGio0L.js", "/assets/config-CmmmZji6.js", "/assets/index-C1nQuyem.js", "/assets/visually-hidden-DEe2ugKV.js", "/assets/use-spring-DfxOLirH.js", "/assets/meta-BSWQDWg9.js", "/assets/decoder-text-EXfoW_qo.js", "/assets/image-BEhxrdLd.js", "/assets/useScrollToHash-C4ZhDZj9.js", "/assets/divider-BWx6OcfP.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/route-P56FuPXN.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/image-cNt8ozvO.css", "/assets/divider-BGrE333F.css", "/assets/route-D3R5eEKe.css"] } }, "url": "/assets/manifest-9dc2b05e.js", "version": "9dc2b05e" };
